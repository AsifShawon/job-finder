...
class Source(Base):
    ...
    is_official_seed_source: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    is_deletable: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True)
    settings_json: Mapped[dict[str, Any]] = mapped_column(JSON, default=dict, nullable=False, server_default="{}")
    last_status: Mapped[str | None] = mapped_column(String(40))
    discovered_item_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0, server_default="0")
    imported_job_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0, server_default="0")
    skipped_item_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0, server_default="0")
...
class RawDocument(Base):
    ...
    detected_item_type: Mapped[str | None] = mapped_column(String(60))
...
class Opportunity(Base):
    ...
    education_min: Mapped[str | None] = mapped_column(String(120))
    experience_min_years: Mapped[float | None] = mapped_column(Float)
    languages_required: Mapped[list[str]] = mapped_column(JSON, default=list, nullable=False, server_default="[]")
    ...
    accommodation: Mapped[bool | None] = mapped_column(Boolean)
    food: Mapped[bool | None] = mapped_column(Boolean)
    transport: Mapped[bool | None] = mapped_column(Boolean)
    contract_type: Mapped[str | None] = mapped_column(String(120))
    posting_date: Mapped[Date | None] = mapped_column(Date)
    visa_or_iqama_requirement: Mapped[str | None] = mapped_column(Text)
    nationality_requirement: Mapped[str | None] = mapped_column(Text)
    documents_required: Mapped[list[str]] = mapped_column(JSON, default=list, nullable=False, server_default="[]")
    application_steps: Mapped[list[str]] = mapped_column(JSON, default=list, nullable=False, server_default="[]")
    ...
    source_trust_tier: Mapped[str | None] = mapped_column(String(80))
    bangladesh_applicability: Mapped[str | None] = mapped_column(String(20))
    bangladesh_applicability_reason: Mapped[str | None] = mapped_column(Text)
    rural_user_fit_score: Mapped[float] = mapped_column(Float, default=0.0, nullable=False, server_default="0")
    bangladesh_applicability_score: Mapped[float] = mapped_column(Float, default=0.0, nullable=False, server_default="0")
    category_match_score: Mapped[float] = mapped_column(Float, default=0.0, nullable=False, server_default="0")
    ai_confidence: Mapped[float] = mapped_column(Float, default=0.0, nullable=False, server_default="0")
    extraction_warnings: Mapped[list[str]] = mapped_column(JSON, default=list, nullable=False, server_default="[]")
    ...
    admin_status: Mapped[str] = mapped_column(String(30), nullable=False, default="needs_review", server_default="needs_review")
